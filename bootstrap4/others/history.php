    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">História</h1>
        </div>
                ...
                <tr>
                    <td>
                        <div>
                            <table>
                                <tr>
                                    <td id="wrapper" style="width: 100px; height: 100px; border:1px solid black;">
                                        <div class="item" style="width: 50px; height: 50px; border:1px solid black;"></div>
                                    </td>
                                </tr>
                            </table>
                        </div>

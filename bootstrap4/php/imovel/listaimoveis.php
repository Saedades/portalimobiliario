...
$active_TAB = (isset($_GET['mn'])) ? $_GET['mn'] : 0;
...
switch($active_TAB) {
  ...
  case 1:   $query = "SELECT * FROM imoveis WHERE user=" . $_SESSION['login'];
            break;  //os meus imoveis


  case 2:   $query = "SELECT * FROM imoveis WHERE dist=2";
            break; //os imoveis da rede


  case 3:   $query = "SELECT * FROM imoveis WHERE ((user=" . $_SESSION['login'] . "  AND fav=1) OR (dist=2 AND fav=1))";
            break;  //os imoveis da favoritos
}
...
if($active_secondary_TAB!='100') {
  $query .= ' AND estado!=100';
}
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
          ...
          <h1 class="h3 mb-4 text-gray-800" style="margin-left:2vw;">Imóveis angariados</h1> 



          <ul class="nav nav-pills" style="margin-left:3vh; margin-bottom:1vh;">
            <li class="nav-item">
              <a class="nav-link <?php echo ($active_TAB==1) ? 'active' : ''; ?>" href="listaimoveis.php?mn=1">Os Meus Imóveis</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo ($active_TAB==2) ? 'active' : ''; ?>" href="listaimoveis.php?mn=2" >Imóveis da Rede</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo ($active_TAB==3) ? 'active' : ''; ?>" href="listaimoveis.php?mn=3">Imóveis Favoritos</a>
            </li>
            <li class="nav-item" >
              <a class="nav-link disabled" href="listaimoveis.php?mn=4">Arquivo</a>
            </li>
          </ul> 
          ...
          <a href="imovel.php" style="float:right; margin-right:2vw;" class="btn btn-primary btn-icon-split col-2">
            ...
            <span class="text" style="padding-left: 2vw;">Novo Imóvel</span>
          </a>
          ...
          <div class="container-fluid">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              ?>" href="listaimoveis.php?mn=<?php echo $active_TAB;?>&tt=999">Todos</a></li>
            </ul>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Aloha 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script>
    $(document).ready(function () {
      ...
      $('.a_contact').dblclick(function () {
        ...
        window.location.replace('imovel.php?id=' + the_id);
      });

      $('.t_imoveis').first().DataTable({
        "searching": true,
        "filter": true,
        "bPaginate": false,
        "bLengthChange": false,
      ...
      //$('.t_imoveis2').DataTable().columns.adjust().draw();

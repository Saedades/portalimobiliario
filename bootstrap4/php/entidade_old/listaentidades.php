              ...
              <th style="width:25%">Interesse</th>
                        ...
                        foreach($contactlist as $mycontact) {
                            echo '<tr class="a_contact" data-theid="' . $mycontact['id'] . '">';
                                echo '<td style="width:30%">'. $mycontact['nome'] . "</td>";
                                echo '<td style="width:15%">'.$conn->query("SELECT nome FROM entidade_tipo WHERE id=" . $mycontact['tipo'])->fetch_assoc()['nome'] ."</td>";
                                echo '<td style="width:25%">'.$conn->query("SELECT nome FROM interesses WHERE id=" . $mycontact['interesse'])->fetch_assoc()['nome']."</td>";
                                echo '<td style="width:25%">'.$mycontact['telemovel']."</td>";
